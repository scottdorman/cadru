...
namespace Cadru.Data.Csv
{
...
#endif
    {
        ...
        /// <summary>
        /// Defines the default escape character letting insert quotation
        /// characters inside a quoted field.
        /// </summary>
        public const char DefaultEscape = '"';

        /// <summary>
        /// Defines the default comment character indicating that a line is
        /// commented out.
        /// </summary>
        public const char DefaultComment = '#';

        /// <summary>
        /// Defines the default value for AddMark indicating should the
        /// CsvReader add null bytes removal mark ([removed x null bytes])
        /// </summary>
        private const bool DefaultAddMark = false;

        /// <summary>
        /// Defines the default value for Threshold indicating when the
        /// CsvReader should replace/remove consecutive null bytes
        /// </summary>
        ...
        /// <summary>
        /// Contains the dictionary of field indexes by header. The key is the
        /// field name and the value is its index.
        /// </summary>
        ...
        /// <summary>
        /// Contains the array of the field values for the current record. A
        /// null value indicates that the field have not been parsed.
        /// </summary>
        ...
        /// <summary>
        /// Indicates if the first record is in cache. This can happen when
        /// initializing a reader with no headers because one record must be
        /// read to get the field count automatically
        /// </summary>
        private bool _firstRecordInCache;

        /// <summary>
        /// Like CsvReader(TextReader reader, bool hasHeaders) but removes
        /// consecutive null bytes above a threshold from source stream.
        /// </summary>
        /// <param name="stream">
        /// A <see cref="T:Stream"/> pointing to the CSV file.
        /// </param>
        ...
        /// </param>
        /// <param name="encoding">
        /// specifies the encoding of the underlying stream.
        /// </param>
        /// <param name="addMark">
        /// <see langword="true"/> if want to add a mark ([removed x null
        /// bytes]) to indicate removal, remove silently if <see langword="false"/>.
        /// </param>
        ...
        /// <summary>
        /// Like CsvReader(TextReader reader, bool hasHeaders, int bufferSize)
        ...
        /// <summary>
        /// Like CsvReader(TextReader reader, bool hasHeaders, char delimiter)
        /// but removes consecutive null bytes above a threshold from source stream.
        /// </summary>
        /// <param name="stream">
        /// A <see cref="T:Stream"/> pointing to the CSV file.
        ...
        /// <summary>
        /// Like CsvReader(TextReader reader, bool hasHeaders, char delimiter,
        /// int bufferSize) but removes consecutive null bytes above a threshold
        /// from source stream.
        /// </summary>
        /// <param name="stream">
        /// A <see cref="T:Stream"/> pointing to the CSV file.
        ...
        /// <summary>
        /// Like CsvReader(TextReader reader, bool hasHeaders, char delimiter,
        /// char quote, char escape, char comment, ValueTrimmingOptions
        /// trimmingOptions, string nullValue) but removes consecutive null
        /// bytes above a threshold from source stream.
        /// </summary>
        /// <param name="stream">
        /// A <see cref="T:Stream"/> pointing to the CSV file.
        /// </param>
        ...
        /// Like CsvReader(TextReader reader, bool hasHeaders, char delimiter,
        /// char quote, char escape, char comment, ValueTrimmingOptions
        /// trimmingOptions, int bufferSize, string nullValue) but removes
        /// consecutive null bytes above a threshold from source stream.
        /// </summary>
        /// <param name="stream">
        /// A <see cref="T:Stream"/> pointing to the CSV file.
        ...
        /// <summary>
        /// Occurs when HasHeaders is true and a duplicate Column Header Name is
        /// encountered. Setting the HeaderName property on this column will
        /// prevent the library from throwing a duplicate key exception
        /// </summary>
        ...
        /// <summary>
        /// Gets the escape character letting insert quotation characters inside
        /// a quoted field.
        /// </summary>
        /// <value>
        /// The escape character letting insert quotation characters inside a
        ...
        /// </summary>
        /// <value>
        /// <see langword="true"/> if spaces at the start and end of a field are
        /// trimmed, otherwise, <see langword="false"/>.
        /// </value>
        ...
        /// <summary>
        /// Gets or sets a value giving a maxmimum length (in bytes) for any
        /// quoted field.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the default header name when it is an empty string or
        /// only whitespaces. The header index will be appended to the specified name.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets whether we should use the column default values if the
        /// field is not in the record.
        /// </summary>
        ...
        /// <para>
        /// A value of <see cref="M:Int32.MinValue"/> means that the reader has
        /// not been initialized yet. Otherwise, a negative value means that no
        ...
        /// <summary>
        /// Indicates if a parse error occured for the current record. Resets
        /// after each successful record read.
        /// </summary>
        ...
        /// </summary>
        /// <value>The field with the specified name and record position.</value>
        /// <exception cref="T:ArgumentNullException">
        /// <paramref name="field"/> is <see langword="null"/> or an empty string.
        /// </exception>
        /// <exception cref="T:InvalidOperationException">
        /// The CSV does not have headers ( <see cref="M:HasHeaders"/> property
        ...
        /// </summary>
        /// <value>
        /// The field at the specified index and record position. A
        /// <see langword="null"/> is returned if the field cannot be found for
        /// the record.
        /// </value>
        /// <exception cref="T:ArgumentOutOfRangeException">
        ...
        /// <summary>
        /// Gets the field with the specified name. <see cref="M:hasHeaders"/>
        ...
        /// <summary>
        /// Copies the field array of the current record to a one-dimensional
        /// array, starting at the beginning of the target array.
        /// </summary>
        /// <param name="array">
        /// The one-dimensional <see cref="T:Array"/> that is the destination of
        ...
        /// </exception>
        /// <exception cref="T:ArgumentOutOfRangeException">
        /// <paramref name="index"/> is les than zero or is equal to or greater
        /// than the length <paramref name="array"/>.
        /// </exception>
        /// <exception cref="InvalidOperationException">No current record.</exception>
        /// <exception cref="ArgumentException">
        /// The number of fields in the record is greater than the available
        /// space from <paramref name="index"/> to the end of <paramref name="array"/>.
        /// </exception>
        ...
        /// <summary>
        /// Determines whether the character at the specified position is a new
        /// line delimiter.
        /// </summary>
        /// <param name="pos">The position of the character to verify.</param>
        /// <returns>
        /// <see langword="true"/> if the character at the specified position is
        /// a new line delimiter; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// <summary>
        /// Reads the field at the specified index. Any unread fields with an
        /// inferior index will also be read as part of the required parsing.
        /// </summary>
        ...
        /// <returns>
        /// The field at the specified index. A <see langword="null"/> indicates
        /// that an error occured or that the last field has been reached during initialization.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        ...
        private string ReadField(int field, bool initializing, bool discardValue)
        {
            if (!initializing)
            {
                ...
                {
                    // Use the column default as UseColumnDefaults is true at
                    // this point
            ...
            while (index < field + 1)
            {
                // Handle case where stated start of field is past buffer This
                // can occur because _nextFieldStart is simply 1 + last char
                // position of previous field
                ...
                else if (this._nextFieldStart == this._bufferLength)
                {
                    ...
                    // If current field is the requested field, then the value
                    // of the field is "" as in "f1,f2,f3,(\s*)" otherwise, the
                    // CSV is malformed
                    ...
                    else if (this._buffer[this._nextFieldStart] != this.Quote)
                    {
                        ...
                        if (!discardValue)
                        {
                            ...
                            else
                            {
                                ...
                                // If pos <= 0, that means the trimming went
                                // past buffer start, and the concatenated value
                        ...
                        if (this._eol || this._eof)
                        {
                            ...
                            // Reaching a new line is ok as long as the parser
                            // is initializing or it is the last field
                    ...
                    else
                    {
                        ...
                        for (; ; )
                        {
                            while (pos < this._bufferLength)
                            {
                                ...
                                // IF current char is escape AND (escape and
                                // quote are different OR next char is a quote)
                        ...
                        if (!this._eof)
                        {
                            ...
                            // Skip new line delimiter if initializing or last
                            // field (if the next field is missing, it will be
                            // caught when parsed)
                            ...
                            // If no delimiter is present after the quoted field
                            // and it is not the last field, then it is a
                            // parsing error
                ...
                if (index == field)
                {
                    // If initializing, return null to signify the last field
                    // has been reached
        ...
        protected virtual bool ReadNextRecord(bool onlyReadHeaders, bool skipToNextLine)
        {
            ...
            if (!this._initialized)
            {
                ...
                // Keep growing _fields array until the last field has been
                // found and then resize it to its final correct size
                ...
                // _fieldCount contains the last field index, but it must
                // contains the field count, so increment by 1
                this._fieldCount++;
                ...
                if (this.HasHeaders)
                {
                    ...
                    if (!onlyReadHeaders)
                    {
                        ...
                        // but in fact would probably cause many subtle bugs
                        // because a derived class does not expect a recursive
                        // behavior so simply do what is needed here and no more.
            ...
            else
            {
                ...
                // Check to see if the first record is in cache. This can happen
                // when initializing a reader with no headers because one record
        ...
        /// <summary>
        /// Skips empty and commented lines. If the end of the buffer is
        /// reached, its content be discarded and filled again from the reader.
        /// </summary>
        /// <param name="pos">
        /// The position in the buffer where to start parsing. Will contains the
        /// resulting position after the operation.
        /// </param>
        /// <returns>
        /// <see langword="true"/> if the end of the reader has not been
        ...
        /// <summary>
        /// Skips ahead to the next NewLine character. If the end of the buffer
        /// is reached, its content be discarded and filled again from the reader.
        /// </summary>
        /// <param name="pos">
        /// The position in the buffer where to start parsing. Will contains the
        /// resulting position after the operation.
        ...
        private void HandleParseError(MalformedCsvException error, ref int pos)
        {
            ...
            switch (this.DefaultParseErrorAction)
            {
                ...
                case ParseErrorAction.RaiseEvent:
                    ...
                    switch (e.Action)
                    {
                        ...
                        case ParseErrorAction.AdvanceToNextLine:
                            // already at EOL when fields are missing, so don't
                            // skip to next line in that case
                ...
                case ParseErrorAction.AdvanceToNextLine:
                    // already at EOL when fields are missing, so don't skip to
                    // next line in that case
                    if (!this.MissingFieldFlag && pos >= 0)
                    {
                        this.SkipToNewLine(ref pos);
                    }
        ...
        /// <see cref="T:MissingFieldAction.TreatAsParseError"/>, then the parse
        /// error will be handled according to <see cref="DefaultParseErrorAction"/>.
        /// </returns>
        ...
        /// <summary>
        /// Returns an <see cref="T:RecordEnumerator"/> that can iterate through
        /// CSV records.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Returns an <see cref="T:System.Collections.Generics.IEnumerator"/>
        /// that can iterate through CSV records.
        /// </summary>
        /// <returns>
        /// An <see cref="T:System.Collections.Generics.IEnumerator"/> that can
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="T:System.Collections.IEnumerator"/> that can iterate
        /// through CSV records.
        /// </returns>
        /// <exception cref="T:System.ComponentModel.ObjectDisposedException">
        /// The instance has been disposed of.
        ...
        /// </summary>
        /// <value>
        /// <see langword="true"/> if the instance has been disposed of;
        /// otherwise, <see langword="false"/>.
        /// </value>
        ...
        /// <summary>
        /// Checks if the instance has been disposed of, and if it has, throws
        /// an <see cref="T:System.ComponentModel.ObjectDisposedException"/>;
        ...
        /// </exception>
        /// <remarks>
        /// Derived classes should call this method at the start of all methods
        /// and properties that should not be accessed after a call to <see cref="M:Dispose()"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Calls <see cref="M:Dispose(Boolean)"/> with the disposing parameter
        /// set to <see langword="true"/> to free unmanaged and managed resources.
        /// </remarks>
        public void Dispose()
        {
            if (!this._isDisposed)
        ...
        {
            // Refer to
            // http://www.bluebytesoftware.com/blog/PermaLink,guid,88e62cdf-5919-4ac7-bc33-20c06ae539ae.aspx
            ...
            if (!this._isDisposed)
            {
                try
                {
                    // Dispose-time code should call Dispose() on all owned
                    // objects that implement the IDisposable interface. "owned"
                    // means objects whose lifetime is solely controlled by the
                    // container. In cases where ownership is not as
                    // straightforward, techniques such as HandleCollector can
                    // be used. Large managed object fields should be nulled out.

                    // Dispose-time code should also set references of all owned
                    // objects to null, after disposing them. This will allow
                    // the referenced objects to be garbage collected even if
                    // not all references to the "parent" are released. It may
                    // be a significant memory consumption win if the referenced
                    // objects are large, such as big arrays, collections, etc.
                    if (disposing)
                    {
                ...
                finally
                {
                    ...
                    // Catch any issues about firing an event on an already
                    // disposed object.
                    try
                    {
        ...
        /// before the instance is reclaimed by garbage collection.
        /// </summary>
        ~CsvReader()
        {
#if DEBUG
