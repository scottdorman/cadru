...
namespace Cadru.UnitTest.Framework
{
    ...
    public static partial class AssertExtensions
    {
        ...
        public static void IsGreaterOrEqual(this Assert assert, byte expected, byte actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, byte expected, byte actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, byte expected, byte actual, string message, params object[] parameters)
        {
            if (expected < actual)
            {
                Helpers.HandleFail("Assert.IsGreaterOrEqual", message, parameters);
            }
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, sbyte expected, sbyte actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, sbyte expected, sbyte actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, char expected, char actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, char expected, char actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, decimal expected, decimal actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, decimal expected, decimal actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, double expected, double actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, double expected, double actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, float expected, float actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, float expected, float actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, int expected, int actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, int expected, int actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, uint expected, uint actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, uint expected, uint actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, long expected, long actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, long expected, long actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, ulong expected, ulong actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, ulong expected, ulong actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, short expected, short actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, short expected, short actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual(this Assert assert, ushort expected, ushort actual)
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual(this Assert assert, ushort expected, ushort actual, string message)
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected.ToString(CultureInfo.CurrentCulture.NumberFormat), actual.ToString(CultureInfo.CurrentCulture.NumberFormat));
        }
        ...
        public static void IsGreaterOrEqual<T>(this Assert assert, T expected, T actual) where T : IComparable
        {
            assert.IsGreaterOrEqual(expected, actual, Strings.IsGreaterOrEqualFailMsg);
        }
        ...
        /// is less than <paramref name="expected"/>. The message is shown in test results.
        /// </param>
        public static void IsGreaterOrEqual<T>(this Assert assert, T expected, T actual, string message) where T : IComparable
        {
            assert.IsGreaterOrEqual(expected, actual, message, expected, actual);
        }
