...
namespace Cadru.UnitTest.Framework
{
    ...
    public static partial class StringAssertExtensions
    {
        ...
        public static void AreEqualIgnoringCase(this StringAssert assert, string expected, string actual)
        {
        ...
        /// </param>
        public static void AreEqualIgnoringCase(this StringAssert assert, string expected, string actual, string message)
        {
        ...
        /// </param>
        public static void AreEqualIgnoringCase(this StringAssert assert, string expected, string actual, string message, params object?[] parameters)
        {
            if (String.Compare(expected, actual, StringComparison.CurrentCultureIgnoreCase) != 0)
            {
                Helpers.HandleFail("StringAssert.AreEqualIgnoringCase", message, parameters);
            }
        }
        ...
        /// <param name="expected">The expected string.</param>
        /// <param name="actual">The actual string.</param>
        public static void AreNotEqualIgnoringCase(this StringAssert assert, string expected, string actual)
        {
        ...
        /// A message to display. This message can be seen in the unit test results.
        /// </param>
        public static void AreNotEqualIgnoringCase(this StringAssert assert, string expected, string actual, string message)
        {
        ...
        /// An array of parameters to use when formatting <paramref name="message"/>.
        /// </param>
        public static void AreNotEqualIgnoringCase(this StringAssert assert, string expected, string actual, string message, params object?[] parameters)
        {
            if (String.Compare(expected, actual, StringComparison.CurrentCultureIgnoreCase) == 0)
            {
                Helpers.HandleFail("StringAssert.AreEqualIgnoringCase", message, parameters);
