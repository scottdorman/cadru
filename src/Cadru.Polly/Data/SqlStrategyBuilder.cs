...
namespace Cadru.Polly.Data
{
    ...
    public abstract class SqlStrategyBuilder
    {
        ...
        /// <summary>
        /// Builds a NoOp <see cref="Policy"/> that will execute without any
        /// custom behavior.
        /// </summary>
        ...
        public ISqlStrategy Build()
        {
            ...
            // The order of policies into the list is important (not mandatory)
            // in order to get a consistent resilience strategy. https://github.com/App-vNext/Polly/wiki/PolicyWrap#usage-recommendations
        ...
        /// <summary>
        /// Gets a <see cref="PolicyBuilder"/> which handles the exceptions in
        /// the default <see cref="IExceptionHandlingStrategy"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets a <see cref="PolicyBuilder"/> which handles all of the
        /// exceptions in <see cref="ExceptionHandlingStrategies"/>.
        /// </summary>
        /// <returns>A <see cref="PolicyBuilder"/> instance.</returns>
