...
namespace Cadru.Polly.Sql
{
    ...
    public abstract class SqlStrategyFactory : ISqlStrategyFactory
    {
        ...
        protected abstract ISqlStrategy CreateStrategyImplementation(ISqlStrategyConfiguration? strategyConfiguration);

        /// <inheritdoc/>
        public ISqlStrategy CreateStrategy(ISqlStrategyConfiguration? strategyConfiguration)
        {
            return this.CreateStrategyImplementation(strategyConfiguration).BuildPolicies();
        }
    }
}