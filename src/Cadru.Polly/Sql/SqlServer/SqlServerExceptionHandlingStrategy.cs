...
namespace Cadru.Polly.Sql.SqlServer
{
    ...
    /// </summary>
    public class SqlServerTransientExceptionHandlingStrategy : IExceptionHandlingStrategy<SqlException>
    {
        /// <inheritdoc/>
        public bool ShouldHandle([NotNull] SqlException exception)
        {
    ...
    /// </summary>
    public class NetworkConnectivityExceptionHandlingStrategy : IExceptionHandlingStrategy<SqlException>
    {
        /// <inheritdoc/>
        public bool ShouldHandle([NotNull] SqlException exception)
        {
    ...
    /// </summary>
    public class SqlServerTransientTransactionExceptionHandlingStrategy : IExceptionHandlingStrategy<SqlException>
    {
        /// <inheritdoc/>
        public bool ShouldHandle([NotNull] SqlException exception)
        {
    ...
    /// </summary>
    public class SqlServerTimeoutExceptionHandlingStrategy : IExceptionHandlingStrategy<SqlException>
    {
        /// <inheritdoc/>
        public bool ShouldHandle([NotNull] SqlException exception)
        {
