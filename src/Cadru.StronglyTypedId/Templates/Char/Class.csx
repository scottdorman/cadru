...
namespace {{ ContainingNamespace }}
{
    ...
    {{~ end ~}}
    partial class {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        /// <summary>
        ...
        static {{ TypeName }}()
        {
            {{ TypeName }}.Empty = new {{ TypeName}}(char.MinValue);
        ...
        /// </summary>
        public static {{ TypeName }} New(char? Value = null) => new(Value ?? char.MinValue);
        ...
        /// <exception cref="OverflowException"><paramref name="s" /> is not representable by <see name="TestcharId" />.</exception>
        ...
        {
            if (char.TryParse(s, out var parsedValue))
            {
        ...
        /// </summary>
        public {{ TypeName }}(char Value)
        {
            this.Value = Value;
        }

        public void Deconstruct(out char Value)
        {
            Value = this.Value;
        }

        protected {{ TypeName }}({{ TypeName }} original)
        {
        ...
        {
            return this.Equals(obj as {{ TypeName }});
        }
        ...
        public virtual bool Equals({{ TypeName }}? other)
        {
            ...
            {
                flag = (other == null || !(this.EqualityContract == other.EqualityContract) ? false : EqualityComparer<char>.Default.Equals(this.Value, other.Value));
            }
            return flag;
        }
        ...
        {
            return EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<char>.Default.GetHashCode(this.Value);
        }
        ...
        public static bool operator ==({{ TypeName }}? left, {{ TypeName }}? right)
        {
            ...
            {
                flag = (left == null ? false : left.Equals(right));
            }
            return flag;
        }
        ...
        protected virtual string ToDebugString()
        {
