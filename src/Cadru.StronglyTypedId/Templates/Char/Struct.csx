...
namespace {{ ContainingNamespace }}
{
    ...
    readonly partial struct {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        /// </summary>
        public char Value { readonly get; init; }
        ...
        {
            return EqualityComparer<char>.Default.Equals(this.Value, other.Value);
        }

        /// <inheritdoc />
        public override int GetHashCode()
        {
            return EqualityComparer<char>.Default.GetHashCode(this.Value);
        }
