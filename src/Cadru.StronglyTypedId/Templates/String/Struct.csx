...
namespace {{ ContainingNamespace }}
{
    ...
    [System.Diagnostics.DebuggerNonUserCode]    [System.Diagnostics.DebuggerDisplay("{ToDebugString()}")]
    ...
    readonly partial struct {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        /// </summary>
        public string Value { readonly get; init; }
        ...
        {
            return EqualityComparer<string>.Default.GetHashCode(this.Value);
        }
