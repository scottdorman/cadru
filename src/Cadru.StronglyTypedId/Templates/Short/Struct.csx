...
namespace {{ ContainingNamespace }}
{
    ...
    readonly partial struct {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        /// </summary>
        public short Value { readonly get; init; }
        ...
        {
            return EqualityComparer<short>.Default.Equals(this.Value, other.Value);
        }

        /// <inheritdoc />
        public override int GetHashCode()
        {
            return EqualityComparer<short>.Default.GetHashCode(this.Value);
        }
