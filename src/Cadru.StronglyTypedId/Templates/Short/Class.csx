...
namespace {{ ContainingNamespace }}
{
    ...
    partial class {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        /// </summary>
        public static {{ TypeName }} New(short? Value = null) => new(Value ?? -1);
        ...
        {
            var parsedValue = short.Parse(s, style, provider);
        ...
        {
            if (short.TryParse(s, style, provider, out var parsedValue))
            {
        ...
        public void Deconstruct(out short Value)
        {
            Value = this.Value;
        }
        ...
        public virtual bool Equals({{ TypeName }}? other)
        {
            ...
            {
                flag = (other == null || !(this.EqualityContract == other.EqualityContract) ? false : EqualityComparer<short>.Default.Equals(this.Value, other.Value));
            }
            return flag;
        }
        ...
        {
            return EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<short>.Default.GetHashCode(this.Value);
        }
