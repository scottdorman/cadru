...
namespace {{ ContainingNamespace }}
{
    ...
    partial class {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        static {{ TypeName }}()
        {
            {{ TypeName }}.Empty = new {{ TypeName}}(Guid.Empty);
        ...
        /// </summary>
        public static {{ TypeName }} New() => new(Guid.NewGuid());
        ...
        /// value represented by the specified <see cref="Guid"/>.
        /// </summary>
        public {{ TypeName }}(Guid Value)
        {
            this.Value = Value;
        }
        ...
        public virtual bool Equals({{ TypeName }}? other)
        {
            ...
            {
                flag = (other == null || !(this.EqualityContract == other.EqualityContract) ? false : EqualityComparer<Guid>.Default.Equals(this.Value, other.Value));
            }
            return flag;
        }
        ...
        {
            return EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<Guid>.Default.GetHashCode(this.Value);
        }
