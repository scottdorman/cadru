...
namespace {{ ContainingNamespace }}
{
    ...
    readonly partial struct {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        /// </summary>
        public Guid Value { readonly get; init; }
        ...
        {
            return EqualityComparer<Guid>.Default.Equals(this.Value, other.Value);
        }

        /// <inheritdoc />
        public override int GetHashCode()
        {
            return EqualityComparer<Guid>.Default.GetHashCode(this.Value);
        }
