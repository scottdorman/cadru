...
namespace {{ ContainingNamespace }}
{
    ...
    {{~ end ~}}
    {{ if IsRecordStruct }}readonly partial record struct{{ else }}partial record class{{ end }} {{ TypeName }}(Guid Value) : IComparable, IComparable<{{ TypeName }}>
    {
        /// <summary>
        ...
        [System.Diagnostics.DebuggerStepperBoundary]
        [System.Diagnostics.DebuggerStepThrough]
        public static {{ TypeName }} New(Guid Value) => new(Value);
