...
namespace {{ ContainingNamespace }}
{
    ...
    partial class {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        /// </summary>
        public static {{ TypeName }} New(long? Value = null) => new(Value ?? -1);
        ...
        {
            var parsedValue = long.Parse(s, style, provider);
        ...
        {
            if (long.TryParse(s, style, provider, out var parsedValue))
            {
        ...
        public virtual bool Equals({{ TypeName }}? other)
        {
            ...
            {
                flag = (other == null || !(this.EqualityContract == other.EqualityContract) ? false : EqualityComparer<long>.Default.Equals(this.Value, other.Value));
            }
            return flag;
        }
        ...
        {
            return EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<long>.Default.GetHashCode(this.Value);
        }
