...
namespace {{ ContainingNamespace }}
{
    ...
    readonly partial struct {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        /// </summary>
        public long Value { readonly get; init; }
        ...
        {
            return EqualityComparer<long>.Default.Equals(this.Value, other.Value);
        }

        /// <inheritdoc />
        public override int GetHashCode()
        {
            return EqualityComparer<long>.Default.GetHashCode(this.Value);
        }
