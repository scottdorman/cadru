...
namespace {{ ContainingNamespace }}
{
    ...
    {{~ end ~}}
    {{ if IsRecordStruct }}readonly partial record struct{{ else }}partial record class{{ end }} {{ TypeName }}(byte Value) : IComparable, IComparable<{{ TypeName }}>
    {
        /// <summary>
        ...
        /// <summary>Parses a span of byteacters into a value.</summary>
        /// <param name="s">The span of byteacters to parse.</param>
        ...
        /// <summary>Tries to parse a span of byteacters into a value.</summary>
        /// <param name="s">The span of byteacters to parse.</param>
