...
namespace {{ ContainingNamespace }}
{
    ...
    partial class {{ TypeName }} : IComparable, IComparable<{{ TypeName }}>, IEquatable<{{ TypeName }}>
    {
        ...
        public virtual bool Equals({{ TypeName }}? other)
        {
            ...
            {
                flag = (other == null || !(this.EqualityContract == other.EqualityContract) ? false : EqualityComparer<byte>.Default.Equals(this.Value, other.Value));
            }
            return flag;
        }
        ...
        {
            return EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<byte>.Default.GetHashCode(this.Value);
        }
