...
namespace Cadru
{
    ...
    /// <see cref="UnixTimestamp"/> is constrained to the same date and time
    /// range as <see cref="DateTime"/>.
    /// </remarks>
    ...
    public partial struct UnixTimestamp : IFormattable, IComparable, IComparable<UnixTimestamp>, IEquatable<UnixTimestamp>
    {
        ...
        /// <see cref="UnixTimestamp"/>. This field is read-only.
        /// </summary>
        /// <remarks>
        ...
        /// <see cref="UnixTimestamp.MinValue"/> or greater than <see cref="UnixTimestamp.MaxValue"/>.
        /// </exception>
        ...
        /// <summary>
        /// Gets a <see cref="UnixTimestamp"/> object that is set to the current
        ...
        /// (UTC), Thursday, 1 January 1970 represented by current <see cref="UnixTimestamp"/>.
        /// </summary>
        /// <value>
        /// The number of days since 00:00:00 Coordinated Universal Time (UTC),
        /// Thursday, 1 January 1970 represented by current <see cref="UnixTimestamp"/>.
        /// </value>
        ...
        /// <summary>
        /// Determines whether two specified <see cref="UnixTimestamp"/> objects
        ...
        /// <summary>
        /// Returns a new <see cref="UnixTimestamp"/> that adds the value of the
        ...
        /// same as, or later than the specified <see cref="UnixTimestamp"/> value.
        /// </summary>
        ...
        /// equal to the value of the specified <see cref="UnixTimestamp"/> instance.
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="DateTime"/> representing the current
        /// <see cref="UnixTimestamp"/> object.
        /// </returns>
        ...
        /// <see cref="UnixTimestamp"/> object as specified by
