...
namespace Cadru.Extensions
{
    ...
    public static class DateTimeOffsetExtensions
    {
        ...
        {
            return ToRelativeDateString(value, RelativeDateFormattingOption.DayNames);
        }
        #endregion
        ...
        /// </summary>
        /// <param name="value">The <see cref="DateTimeOffset"/> object to convert.</param>
        /// <param name="options">One of the <see cref="RelativeDateFormattingOption"/> values.</param>
        /// <returns>A relative date/time formatted string.</returns>
        public static string ToRelativeDateString(this DateTimeOffset value, RelativeDateFormattingOption options)
        {
            ...
            switch (days)
            {
                ...
                case 4:
                case 5:
                    format = options == RelativeDateFormattingOption.DayNames ? value.ToString("dddd", CultureInfo.CurrentCulture) : String.Format(CultureInfo.CurrentCulture, Resources.RelativeDateFormatStringDaysFromNow, days);
                    break;
                ...
                case -4:
                case -5:
                    format = options == RelativeDateFormattingOption.DayNames ? value.ToString("dddd", CultureInfo.CurrentCulture) : String.Format(CultureInfo.CurrentCulture, Resources.RelativeDateFormatStringDaysAgo, Math.Abs(days));
                    break;
