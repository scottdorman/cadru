...
namespace Cadru.Text
{
    ...
    public static class DataValidation
    {
        ...
        /// <returns>
        /// <see cref="IsAlpha(Char)"/> returns <see langword="true"/> if
        /// <paramref name="expression"/> contains alphabetic characters;
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsAlpha(String)"/> returns <see langword="true"/> if
        /// <paramref name="expression"/> contains alphabetic characters;
        /// otherwise it returns <see langword="false"/>.
        /// </returns>
        /// <remarks>
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsAlphanumeric(Char)"/> returns <see langword="true"/> if
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsAlphanumeric(String)"/> returns <see langword="true"/>
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsCurrency(String)"/> returns <see langword="true"/> if
        /// <paramref name="expression"/> contains a valid currency string;
        /// otherwise it returns <see langword="false"/>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// <see cref="IsCurrency(String, IFormatProvider)"/> returns
        ...
        /// </param>
        /// <returns>
        /// <see cref="IsDate(String)"/> returns <see langword="true"/> if
        /// <paramref name="expression"/> is a string convertible to type
        /// <see cref="DateTime"/>; otherwise, it returns <see langword="false"/>.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// <see cref="IsDate(String)"/> uses the
        /// <see cref="DateTimeFormatInfo.InvariantInfo"/> object.
        /// </para>
        /// </remarks>
        /// <example>
        /// The following example uses the <see cref="IsDate(String)"/> function
        ...
        /// </param>
        /// <returns>
        /// <see cref="IsDate(String, IFormatProvider)"/> returns
        /// <see langword="true"/> if <paramref name="expression"/> is a string
        /// convertible to type <see cref="DateTime"/>; otherwise, it returns <see langword="false"/>.
        /// </returns>
        /// <remarks>
        /// <para>
        /// In Microsoft Windows, the range of valid dates is January 1, 100
        ...
        /// the current date. A typical value to specify is <see cref="DateTimeStyles">None</see>.
        /// </param>
        /// <returns>
        /// <see cref="IsDate(String, IFormatProvider)"/> returns
        /// <see langword="true"/> if <paramref name="expression"/> is a string
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsHexadecimal(Char)"/> returns <see langword="true"/> if
        /// <paramref name="expression"/> contains hexadecimal characters;
        /// otherwise it returns <see langword="false"/>.
        /// </returns>
        /// <remarks>
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsHexadecimal(String)"/> returns <see langword="true"/>
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsNumeric(Char)"/> returns <see langword="true"/> if
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsNumeric(String)"/> returns <see langword="true"/> if
        /// <paramref name="expression"/> contains numeric characters; otherwise
        /// it returns <see langword="false"/>.
        /// </returns>
        /// <remarks>Numeric characters are 0-9.</remarks>
        ...
        /// </param>
        /// <returns>
        /// <see cref="IsNumeric(String, IFormatProvider)"/> returns
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsStrictlyAlpha(Char)"/> returns <see langword="true"/>
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsStrictlyAlpha(String)"/> returns <see langword="true"/>
        /// if <paramref name="expression"/> contains alphabetic characters;
        /// otherwise it returns <see langword="false"/>.
        /// </returns>
        /// <remarks>Alphabetic characters are any letters A-Z or a-z.</remarks>
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsStrictlyAlphanumeric(Char)"/> returns
        /// <see langword="true"/> if <paramref name="expression"/> contains
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsStrictlyAlphanumeric(String)"/> returns
        /// <see langword="true"/> if <paramref name="expression"/> contains
        /// alphabetic characters; otherwise it returns <see langword="false"/>.
        /// </returns>
        /// <remarks>
        ...
        /// <param name="expression">Any string expression.</param>
        /// <returns>
        /// <see cref="IsValidFileName(String)"/> returns <see langword="true"/>
        ...
        /// </param>
        /// <returns>
        /// <see cref="IsValidFileName(String, Boolean)"/> returns
        /// <see langword="true"/> if <paramref name="expression"/> contains a
        ...
        /// <returns>
        /// <see cref="Validate"/> returns <see langword="true"/> if
