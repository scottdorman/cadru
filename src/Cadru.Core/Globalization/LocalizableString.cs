...
namespace Cadru.Globalization
{
    ...
    public class LocalizableString
    {
        ...
        /// name found on the resource type supplied to <see cref="GetLocalizableValue"/>.
        /// </summary>
        public string? Value
        {
        ...
        /// </summary>
        /// <remarks>
        /// If <see cref="ResourceType"/> has been specified and
        /// <see cref="Value"/> is not null, then localization will occur and
        /// the localized value will be returned.
        /// <para>
        /// If <see cref="ResourceType"/> is null then <see cref="Value"/> will
        /// be returned as a literal, non-localized string.
        /// </para>
        /// </remarks>
        /// <exception cref="System.InvalidOperationException">
        /// Thrown if localization fails. This can occur if
        /// <see cref="ResourceType"/> has been specified, <see cref="Value"/>
        /// is not null, but the resource could not be accessed.
        /// <see cref="ResourceType"/> must be a public class, and
        /// <see cref="Value"/> must be the name of a public static string
        ...
        public string? GetLocalizableValue()
        {
            ...
            {
                // If the property value is null, then just cache that value If
                // the resource type is null, then property value is literal, so
                // cache it
                ...
                else
                {
                    ...
                    // We need to detect bad configurations so that we can throw
                    // exceptions accordingly
                    var badlyConfigured = false;

                    // Make sure we found the property and it's the correct
                    // type, and that the type itself is public
                    ...
                    {
                        // Ensure the getter for the property is available as
                        // public static
                    ...
                    // If the property is not configured properly, then throw a
        ...
        /// <summary>
        /// Clears any cached values, forcing <see cref="GetLocalizableValue"/>
