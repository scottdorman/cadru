...
namespace Cadru.Data.Dapper.Configuration
{
    ...
    public partial class DapperContextBuilder
    {
        ...
        /// <summary>
        /// Gets the <see cref="ISqlStrategyFactory"/> used for creating a retry
        /// on failure strategy.
        /// </summary>
        /// <remarks>
        /// <see cref="SqlStrategy.Default"/> is used if
        /// <see cref="RetryOnFailureEnabled"/> is <see langword="false"/> or
