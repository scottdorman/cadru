...
{
    /// <summary>
    /// Helper methods for getting a <see cref="PolicyExecutionEnvironment"/>
    /// from the <see cref="IDapperContext"/>.
    /// </summary>
    public static class DapperPollyContextExtensions
    {
        ...
        /// <returns>
        /// An <see cref="AsyncExecutionEnvironment"/> containing the
        /// <see cref="IAsyncPolicy"/> and <see cref="Context"/>.
        /// </returns>
        ...
        /// <param name="dapperContext">The context instance.</param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> instance to be added to the <see cref="Context"/>.
        /// </param>
        /// <returns>
        /// An <see cref="AsyncExecutionEnvironment"/> containing the
        /// <see cref="IAsyncPolicy"/> and <see cref="Context"/>.
        ...
        /// <param name="dapperContext">The context instance.</param>
        /// <returns>
        /// An <see cref="ExecutionEnvironment"/> containing the
        /// <see cref="ISyncPolicy"/> and <see cref="Context"/>.
        /// </returns>
