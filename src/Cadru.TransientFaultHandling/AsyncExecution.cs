...
namespace Cadru.TransientFaultHandling
{
    ...
    internal class AsyncExecution : AsyncExecution<bool>
    {
        ...
        private static Task<bool> StartAsGenericTask(Func<Task> taskAction)
        {
            ...
            if (task == null)
            {
                throw new ArgumentException(String.Format(CultureInfo.InvariantCulture, Strings.TaskCannotBeNull, nameof(taskAction)), nameof(taskAction));
            }
            ...
            {
                throw new ArgumentException(String.Format(CultureInfo.InvariantCulture, Strings.TaskMustBeScheduled, nameof(taskAction)), nameof(taskAction));
            }
