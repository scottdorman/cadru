//------------------------------------------------------------------------------
// <copyright file="TransientErrorCatchAllStrategy.cs"
...
namespace Cadru.TransientFaultHandling.DetectionStrategies
{
    using System;
    ...
    internal sealed class TransientErrorCatchAllStrategy : ITransientErrorDetectionStrategy
    {
        #region fields
        #endregion
