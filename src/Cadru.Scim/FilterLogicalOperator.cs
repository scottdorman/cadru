...
namespace Cadru.Scim.Filters
{
    ...
    /// <see cref="IFilterExpression"></see> instances together in an <see cref="IFilterGroup"></see>.
    /// </summary>
    public readonly struct FilterLogicalOperator : IEquatable<FilterLogicalOperator>
    {
        ...
        /// <see cref="FilterLogicalOperator"/> structure.
        /// </summary>
        ...
        /// </summary>
        /// <param name="left">
        /// The first <see cref="FilterLogicalOperator"/> to compare.
        /// </param>
        /// <param name="right">
        /// The second <see cref="FilterLogicalOperator"/> to compare.
        /// </param>
        /// <returns>
