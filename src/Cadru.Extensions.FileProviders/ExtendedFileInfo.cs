...
namespace Cadru.Extensions.FileProviders
{
    ...
    /// </summary>
    /// <remarks>
    /// This wraps an <see cref="FileInfo" /> and <see cref="FileVersionInfo" />.
    /// </remarks>
    public sealed partial class ExtendedFileInfo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedFileInfo" /> class
        /// that wraps an instance of <see cref="IFileInfo" />.
        /// </summary>
        ...
        /// <exception cref="NotSupportedException"><paramref name="fileInfo" /> contains a colon (:) in the middle of the string.</exception>
