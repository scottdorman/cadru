...
{
    /// <summary>
    /// A MultiValueDictionary can be viewed as a <see cref="IDictionary"/> that
    /// allows multiple values for any given unique key. While the
    /// MultiValueDictionary API is mostly the same as that of a regular
    /// <see cref="IDictionary"/>, there is a distinction in that getting the
    /// value for a key returns a <see cref="IReadOnlyCollection{TValue}"/> of
    /// values rather than a single value associated with that key.
    /// Additionally, there is functionality to allow adding or removing more
    /// than a single value at once.
    ///
    /// The MultiValueDictionary can also be viewed as a
    /// IReadOnlyDictionary&lt;TKey,IReadOnlyCollection&lt;TValue&gt;t&gt; where
    /// the <see cref="IReadOnlyCollection{TValue}"/> is abstracted from the
        ...
        IReadOnlyDictionary<TKey, IReadOnlyCollection<TValue>>
    {
        ...
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> class that is
        ...
        {
            this._dictionary = new Dictionary<TKey, InnerCollectionView>();
        }
        ...
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> will allocate space for
        /// </param>
        ...
        /// Initializes a new instance of the
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> class that is
        /// empty, has the default initial capacity, and uses the specified <see cref="IEqualityComparer{TKey}"/>.
        /// </summary>
        /// <param name="comparer">
        /// Specified comparer to use for the <typeparamref name="TKey"/> s
        /// </param>
        /// <remarks>
        ...
        {
            this._dictionary = new Dictionary<TKey, InnerCollectionView>(comparer);
        }

        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> class that is
        /// empty, has the specified initial capacity, and uses the specified <see cref="IEqualityComparer{TKey}"/>.
        /// </summary>
        /// <param name="capacity">
        /// Initial number of keys that the
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> will allocate space for
        ...
        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> class that contains
        /// elements copied from the specified
        /// IEnumerable&lt;KeyValuePair&lt;TKey,
        /// IReadOnlyCollection&lt;TValue&gt;&gt;&gt; and uses the default
        /// <see cref="IEqualityComparer{TKey}"/> for the
        ...
        /// elements copied from the specified
        /// IEnumerable&lt;KeyValuePair&lt;TKey,
        /// IReadOnlyCollection&lt;TValue&gt;&gt;&gt; and uses the specified <see cref="IEqualityComparer{TKey}"/>.
        /// </summary>
        /// <param name="enumerable">
        /// IEnumerable to copy elements into this from
        /// </param>
        ...
        /// <summary>
        /// Returns the number of <typeparamref name="TKey"/> s with one or more
        /// associated <typeparamref name="TValue"/> in this <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        ...
        /// <see cref="MultiValueDictionary{TKey,TValue}"/> that has one or more
        /// associated <typeparamref name="TValue"/>.
        /// </summary>
        /// <value>
        /// An <see cref="IEnumerable{TKey}"/> containing each
        /// <typeparamref name="TKey"/> in this
        /// <see cref="MultiValueDictionary{TKey,TValue}"/> that has one or more
        /// associated <typeparamref name="TValue"/>.
        /// </value>
        ...
        /// <summary>
        /// Gets an enumerable of <see cref="IReadOnlyCollection{TValue}"/> from
        /// this <see cref="MultiValueDictionary{TKey,TValue}"/>, where each
        /// <see cref="IReadOnlyCollection{TValue}"/> is the collection of every
        /// <typeparamref name="TValue"/> associated with a
        /// <typeparamref name="TKey"/> present in the <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <value>
        /// An IEnumerable of each <see cref="IReadOnlyCollection{TValue}"/> in
        /// this <see cref="MultiValueDictionary{TKey,TValue}"/>
        /// </value>
        public IEnumerable<IReadOnlyCollection<TValue>> Values => this._dictionary.Values;

        /// <summary>
        /// Get every <typeparamref name="TValue"/> associated with the given
        /// <typeparamref name="TKey"/>. If <paramref name="key"/> is not found
        /// in this <see cref="MultiValueDictionary{TKey,TValue}"/>, will throw
        /// a <see cref="KeyNotFoundException"/>.
        /// </summary>
        /// <param name="key">
        /// The <typeparamref name="TKey"/> of the elements to retrieve.
        /// </param>
        /// <exception cref="ArgumentNullException">
        ...
        /// </exception>
        /// <value>
        /// An <see cref="IReadOnlyCollection{TValue}"/> containing every
        /// <typeparamref name="TValue"/> associated with <paramref name="key"/>.
        /// </value>
        /// <remarks>
        /// Note that the <see cref="IReadOnlyCollection{TValue}"/> returned
        /// will change alongside any changes to the <see cref="MultiValueDictionary{TKey,TValue}"/>
        /// </remarks>
        public IReadOnlyCollection<TValue> this[TKey key]
        {
            get
            {
                ...
                if (this._dictionary.TryGetValue(key, out var collection))
                {
                    return collection;
                }
        ...
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> class that is
        /// empty, has the default initial capacity, and uses the default
        /// <see cref="IEqualityComparer{TKey}"/> for
        /// <typeparamref name="TKey"/>. The internal dictionary will use
        /// instances of the <typeparamref name="TValueCollection"/> class as
        /// its collection type.
        /// </summary>
        /// <typeparam name="TValueCollection">
        /// The collection type that this
        /// <see cref="MultiValueDictionary{TKey, TValue}"/> will contain in its
        /// internal dictionary.
        /// </typeparam>
        /// <returns>
        /// A new <see cref="MultiValueDictionary{TKey, TValue}"/> with the
        /// specified parameters.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        /// <typeparamref name="TValueCollection"/> must not have IsReadOnly set
        /// to true by default.
        /// </exception>
        /// <remarks>
        /// Note that <typeparamref name="TValueCollection"/> must implement
        /// <see cref="ICollection{TValue}"/> in addition to being constructable
        /// through new(). The collection returned from the constructor must
        /// also not have IsReadOnly set to True by default.
        /// </remarks>
        ...
        /// IReadOnlyCollection&lt;TValue&gt;&gt;&gt; and uses the default
        /// <see cref="IEqualityComparer{TKey}"/> for the
        /// <typeparamref name="TKey"/> type. The internal dictionary will use
        /// instances of the <typeparamref name="TValueCollection"/> class as
        /// its collection type.
        /// </summary>
        /// <typeparam name="TValueCollection">
        ...
        /// elements copied from the specified
        /// IEnumerable&lt;KeyValuePair&lt;TKey,
        /// IReadOnlyCollection&lt;TValue&gt;&gt;&gt; and uses the specified
        /// <see cref="IEqualityComparer{TKey}"/> for the
        /// <typeparamref name="TKey"/> type. The internal dictionary will use
        /// instances of the <typeparamref name="TValueCollection"/> class as
        /// its collection type.
        ...
        /// <typeparamref name="TValue"/> to the <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <param name="key">
        /// The <typeparamref name="TKey"/> of the element to add.
        /// </param>
        /// <param name="value">
        /// The <typeparamref name="TValue"/> of the element to add.
        /// </param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="key"/> is <c>null</c>.
        /// </exception>
        /// <remarks>
        /// Unlike the Add for <see cref="IDictionary"/>, the
        /// <see cref="MultiValueDictionary{TKey,TValue}"/> Add will not throw
        /// any exceptions. If the given <typeparamref name="TKey"/> is already
        /// in the <see cref="MultiValueDictionary{TKey,TValue}"/>, then
        /// <typeparamref name="TValue"/> will be added to
        /// <see cref="IReadOnlyCollection{TValue}"/> associated with <paramref name="key"/>
        /// </remarks>
        /// <remarks>
        /// A call to this Add method will always invalidate any currently
        /// running enumeration regardless of whether the Add method actually
        /// modified the <see cref="MultiValueDictionary{TKey, TValue}"/>.
        /// </remarks>
        public void Add(TKey key, TValue value)
        {
            ...
            if (!this._dictionary.TryGetValue(key, out var collection))
            {
                collection = new InnerCollectionView(key, this.NewCollectionFactory());
        ...
        /// <summary>
        /// Adds a number of key-value pairs to this
        /// <see cref="MultiValueDictionary{TKey,TValue}"/>, where the key for
        /// each value is <paramref name="key"/>, and the value for a pair is an
        /// element from <paramref name="values"/>
        /// </summary>
        /// <param name="key">
        /// The <typeparamref name="TKey"/> of all entries to add
        /// </param>
        /// <param name="values">
        /// An <see cref="IEnumerable{TValue}"/> of values to add
        /// </param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="key"/> and <paramref name="values"/> must be non-null
        /// </exception>
        /// <remarks>
        /// A call to this AddRange method will always invalidate any currently
        /// running enumeration regardless of whether the AddRange method
        /// actually modified the <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </remarks>
        ...
        /// <summary>
        /// Removes every <typeparamref name="TKey"/> and
        /// <typeparamref name="TValue"/> from this <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        /// Determines if the given <typeparamref name="TKey"/>-
        /// <typeparamref name="TValue"/> pair exists within this <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        ...
        public bool Contains(TKey key, TValue value)
        {
            ...
            return (this._dictionary.TryGetValue(key, out var collection) && collection.Contains(value));
        }

        /// <summary>
        /// Determines if the given <typeparamref name="TKey"/> exists within
        /// this <see cref="MultiValueDictionary{TKey,TValue}"/> and has at
        /// least one <typeparamref name="TValue"/> associated with it.
        /// </summary>
        /// <param name="key">
        ...
        public bool ContainsKey(TKey key)
        {
            ...
            // Since modification to the MultiValueDictionary is only allowed
            // through its own API, we can ensure that if a collection is in the
            // internal dictionary then it must have at least one associated
            // TValue, or else it would have been removed whenever its final
            // TValue was removed.
            return this._dictionary.ContainsKey(key);
        }

        /// <summary>
        /// Determines if the given <typeparamref name="TValue"/> exists within
        /// this <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <param name="value">
        ...
        {
            foreach (var sublist in this._dictionary.Values)
            {
        ...
        /// <see cref="IReadOnlyCollection{TValue}"/> pairs in this <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Removes every <typeparamref name="TValue"/> associated with the
        /// given <typeparamref name="TKey"/> from the <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <param name="key">
        ...
        public bool Remove(TKey key)
        {
            ...
            if (this._dictionary.TryGetValue(key, out var _) && this._dictionary.Remove(key))
            {
                this._version++;
                return true;
            }
        ...
        /// <typeparamref name="TKey"/>- <typeparamref name="TValue"/> pair from
        /// this <see cref="MultiValueDictionary{TKey,TValue}"/>.
        /// </summary>
        /// <param name="key">
        /// The <typeparamref name="TKey"/> of the element to remove
        /// </param>
        /// <param name="value">
        /// The <typeparamref name="TValue"/> of the element to remove
        /// </param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="key"/> must be non-null
        /// </exception>
        ...
        /// associated with its <typeparamref name="TKey"/>, then that
        /// <typeparamref name="TKey"/> will be removed from the
        /// <see cref="MultiValueDictionary{TKey,TValue}"/> and its associated
        /// <see cref="IReadOnlyCollection{TValue}"/> will be freed as if a call
        /// to <see cref="Remove(TKey)"/> had been made.
        /// </remarks>
        public bool Remove(TKey key, TValue value)
        {
            ...
            if (this._dictionary.TryGetValue(key, out var collection) && collection.RemoveValue(value))
            {
        ...
        /// <summary>
        /// Attempts to get the <typeparamref name="TValue"/> associated with
        /// the given <typeparamref name="TKey"/> and place it into <paramref name="value"/>.
        /// </summary>
        /// <param name="key">
        /// The <typeparamref name="TKey"/> of the element to retrieve
        /// </param>
        /// <param name="value">
        /// When this method returns, contains the <typeparamref name="TValue"/>
        /// associated with the specified <typeparamref name="TKey"/> if it is
