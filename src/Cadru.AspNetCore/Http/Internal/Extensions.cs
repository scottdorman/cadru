...
namespace Cadru.AspNetCore.Http.Internal
{
    internal static class Extensions
    {
        ...
        /// <see cref="HttpResponseMessage.StatusCode"/> was in the range
        /// 200-299; otherwise, <see langword="false"/>.
        /// </returns>
        /// <remarks>
        /// As <see cref="HttpResponse"/> does not have a built-in way to check
        /// for a successful response, this is a wrapper over
        /// <see cref="HttpResponseMessage.IsSuccessStatusCode"/> to standardize
        /// checking between <see cref="HttpResponse"/> and <see cref="HttpResponseMessage"/>.
        /// </remarks>
        ...
        /// <returns>
        /// <see langword="true"/> if <see cref="HttpResponse.StatusCode"/> was
