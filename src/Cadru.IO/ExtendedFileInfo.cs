...
namespace Cadru.IO
{
...
#endif
    {
        ...
        /// </summary>
        /// <value>
        /// A <see cref="DirectoryInfo"/> object representing the parent
        ...
        /// <see cref="DirectoryName"/> property.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// To get the parent directory as a <see cref="DirectoryInfo"/> object,
        /// use the <see cref="Directory"/> property.
        /// </para>
        /// <para>
        /// When first called, <see cref="ExtendedFileInfo"/> calls
        ...
        /// </value>
        /// <exception cref="FileNotFoundException">
        /// The file described by the current <see cref="ExtendedFileInfo"/>
        ...
        /// <remarsk>
        /// <para>
        /// Use the <see cref="IsReadOnly"/> property to quickly determine or
        ...
        /// <exception cref="IOException">
        /// <see cref="Refresh"/> cannot update the state of the file or directory.
        /// </exception>
        /// <exception cref="FileNotFoundException">
        /// <para>The file does not exist.</para>
        /// <para>-or-</para>
        /// <para>The <see cref="Length"/> property is called for a directory.</para>
        /// </exception>
        /// <remarsk>
        /// <para>
        /// This property value is a <see langword="null"/> if the file system
        ...
        /// <remarks>
        /// <para>
        /// Use the <see cref="CopyTo(String, Boolean)"/> method to allow
        ...
        /// Use the <see cref="CopyTo(String)"/> method to prevent overwriting
        ...
        /// </para>
        /// <para>
        /// This method is a wrapper for the functionality provided by <see cref="File.Create(String)"/>.
        /// </para>
        /// </remarks>
        ...
        /// <para>
        /// <b>Windows NT 4.0 Platform Note:</b><see cref="Delete"/> does not
        ...
        /// <exception cref="UnauthorizedAccessException">
        /// The path used to construct this <see cref="ExtendedFileInfo"/>
